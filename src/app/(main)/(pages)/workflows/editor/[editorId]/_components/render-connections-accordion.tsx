...
const RenderConnectionsAccordion = ({connection, state}: Props) => {
    const {
        title,
        image,
        description,
    ...
    const isConnected = alwaysTrue || (nodeConnection[connectionKey] &&
        accessTokenKey && connectionData[accessTokenKey!])
...
export default RenderConnectionsAccordion